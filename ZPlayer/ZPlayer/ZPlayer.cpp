// ZPlayer.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_ZPLAYER, szWindowClass, MAX_LOADSTRING);
	...
	//}
	ZFormPara para;
	para.appIcon = IDI_ZPLAYER;
	para.appIconSmall = IDI_SMALL;
	para.point = Point(0, 0);
	para.size = Size(800, 600);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ZPLAYER));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_ZPLAYER);
